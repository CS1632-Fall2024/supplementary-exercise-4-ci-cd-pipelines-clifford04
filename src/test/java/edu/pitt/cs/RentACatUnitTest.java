...
public class RentACatUnitTest {
	...
	public void setUp() throws Exception {
		...
		// we should use a mock because rent a cat depends on cat so if we want to do unti tests it wont wokr 
		// TODO: Fill in
	 ...
	 * 
	 * use a mock version of a cat for this method 
	 */
	@Test
	public void testGetCatNullNumCats0() {
	//Call getCat(2) using java reflection and a mock cat
	try {
	...
	public void testGetCatNumCats3() {
		...
		//Add c1, c2, and c3 to r using addCat(Cat
		r.addCat(c1);
		r.addCat(c2);
		r.addCat(c3);
		//Call getCat(2) using java reflection
		try {
			// Use reflection to access the private getCat(int) method of class r
			...
			// Call getCat(2) using reflection
			Cat resultCat = (Cat) getCatMethod.invoke(r, 2);
		
			// Verify the result is not null and has an ID of 2
		//	assertNotNull(1);
			//assertEquals(2, resultCat.getId());
		
			// Verify the correct interactions with the mock objects
			Mockito.verify(c2).getId();
		} catch (Exception e) {
			fail("Exception: " + e);
		}
	}
